...
public class BookInspector : UnityEditor.Editor
{
    /// <summary>
    ...
    public override void OnInspectorGUI()
    {
        ...
        var newQuality =
            (EndlessBook.StandinQualityEnum)EditorGUILayout.EnumPopup("Open Middle Quality", currentQuality);
        ...
        {
            if (materialNames[i] != EndlessBook.BookPageRightMaterialName &&
                materialNames[i] != EndlessBook.BookPageLeftMaterialName)
            {
        ...
        var newCurrentPageNumber =
            EditorGUILayout.IntSlider("Current Page", book.CurrentPageNumber, 1, book.LastPageNumber);
        ...
        var newLastPageFillerMaterial = (Material)EditorGUILayout.ObjectField("Page Filler Material",
            book.PageFillerMaterial, typeof(Material), false);
