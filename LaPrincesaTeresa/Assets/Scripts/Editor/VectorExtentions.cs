...
public static class VectorExtentions
{
	...
	public static float Distance (this Vector2 v, Vector2 a, Vector2 b) => Mathf.Abs ((b.y - a.y) * v.x - (b.x - a.x) * v.y + b.x * a.y - b.y * a.x) / Mathf.Sqrt (Mathf.Pow (b.y - a.y, 2) + Mathf.Pow (b.x - a.x, 2));
	/// <summary> Square Distance to line that passses through pointA and pointB. </summary>
	public static float SqrDistance (this Vector2 v, Vector2 a, Vector2 b) => Mathf.Pow ((b.y - a.y) * v.x - (b.x - a.x) * v.y + b.x * a.y - b.y * a.x, 2) / (Mathf.Pow (b.y - a.y, 2) + Mathf.Pow (b.x - a.x, 2));
	#endregion
